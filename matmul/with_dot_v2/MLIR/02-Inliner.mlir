...
#loc58 = loc("/home/ubuntu/triton/python/triton/language/standard.py":31:0)
module {
  ...
  tt.func private @"triton.language.standard.zeros____(0, 0)cconstexpr_128__(0, 1)cconstexpr_64__(1,)cconstexpr_fp32_"() -> tensor<128x64xf32> attributes {noinline = false} {
    ...
    %cst_0 = arith.constant dense<0.000000e+00> : tensor<128x64xf32> loc(#loc55)
    tt.return %cst_0 : tensor<128x64xf32> loc(#loc56)
  ^bb1:  // no predecessors
    %0 = ub.poison : tensor<128x64xf32> loc(#loc57)
    tt.return %0 : tensor<128x64xf32> loc(#loc57)
  } loc(#loc54)
  tt.func private @"triton.language.standard.cdiv__i32__(1,)cconstexpr_64_"(%arg0: i32 loc("/home/ubuntu/triton/python/triton/language/standard.py":31:0)) -> i32 attributes {noinline = false} {
    ...
    %c64_i32_0 = arith.constant 64 : i32 loc(#loc59)
    %0 = arith.extsi %arg0 : i32 to i64 loc(#loc59)
    %1 = arith.extsi %c64_i32_0 : i32 to i64 loc(#loc59)
    %2 = arith.addi %0, %1 : i64 loc(#loc59)
    %c2147483647_i64 = arith.constant 2147483647 : i64 loc(#loc59)
    %c-2147483648_i64 = arith.constant -2147483648 : i64 loc(#loc59)
    %3 = arith.cmpi sle, %2, %c2147483647_i64 : i64 loc(#loc59)
    %4 = arith.cmpi sge, %2, %c-2147483648_i64 : i64 loc(#loc59)
    %5 = arith.andi %3, %4 : i1 loc(#loc59)
    %6 = arith.addi %arg0, %c64_i32_0 : i32 loc(#loc59)
    %c1_i32 = arith.constant 1 : i32 loc(#loc60)
    %c1_i32_1 = arith.constant 1 : i32 loc(#loc60)
    %7 = arith.extsi %6 : i32 to i64 loc(#loc60)
    %8 = arith.extsi %c1_i32_1 : i32 to i64 loc(#loc60)
    %9 = arith.subi %7, %8 : i64 loc(#loc60)
    %c2147483647_i64_2 = arith.constant 2147483647 : i64 loc(#loc60)
    %c-2147483648_i64_3 = arith.constant -2147483648 : i64 loc(#loc60)
    %10 = arith.cmpi sle, %9, %c2147483647_i64_2 : i64 loc(#loc60)
    %11 = arith.cmpi sge, %9, %c-2147483648_i64_3 : i64 loc(#loc60)
    %12 = arith.andi %10, %11 : i1 loc(#loc60)
    %13 = arith.subi %6, %c1_i32_1 : i32 loc(#loc60)
    %c64_i32_4 = arith.constant 64 : i32 loc(#loc61)
    %c64_i32_5 = arith.constant 64 : i32 loc(#loc61)
    %14 = arith.divsi %13, %c64_i32_5 : i32 loc(#loc61)
    tt.return %14 : i32 loc(#loc62)
  ^bb1:  // no predecessors
    %15 = ub.poison : i32 loc(#loc63)
    tt.return %15 : i32 loc(#loc63)
  } loc(#loc58)
} loc(#loc)
...
#loc57 = loc("/home/ubuntu/triton/python/triton/language/standard.py":126:4)
#loc59 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:16)
#loc60 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:22)
#loc61 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:28)
#loc62 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:11)
#loc63 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:4)
