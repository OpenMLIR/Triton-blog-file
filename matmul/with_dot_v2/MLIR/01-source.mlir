...
#loc56 = loc("/home/ubuntu/triton/python/triton/language/standard.py":31:0)
module {
  tt.func public @matrix_multiplication_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg6: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg7: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg8: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %85 = scf.for %arg9 = %81 to %82 step %83 iter_args(%arg10 = %79) -> (tensor<128x64xf32>)  : i32 {
      ...
      %c1_i32_50 = arith.constant 1 : i32 loc(#loc29)
      %c1_i32_51 = arith.constant 1 : i32 loc(#loc29)
      %134 = arith.extsi %123 : i32 to i64 loc(#loc29)
      %135 = arith.extsi %c1_i32_51 : i32 to i64 loc(#loc29)
      ...
      %140 = arith.muli %123, %c1_i32_51 : i32 loc(#loc29)
      %141 = tt.splat %140 : i32 -> tensor<128x64xi32> loc(#loc30)
      %142 = tt.addptr %56, %141 : tensor<128x64x!tt.ptr<f32>>, tensor<128x64xi32> loc(#loc30)
      %cst_54 = arith.constant 0.000000e+00 : f32 loc(#loc31)
      %143 = tt.broadcast %133 : tensor<1x64xi1> -> tensor<128x64xi1> loc(#loc31)
      %cst_55 = arith.constant dense<0.000000e+00> : tensor<128x64xf32> loc(#loc31)
      %144 = tt.load %142, %143, %cst_55 : tensor<128x64x!tt.ptr<f32>> loc(#loc31)
      %145 = tt.expand_dims %34 {axis = 1 : i32} : tensor<64xi32> -> tensor<64x1xi32> loc(#loc32)
      %146 = tt.splat %130 : i32 -> tensor<64x1xi32> loc(#loc33)
      %147 = arith.cmpi slt, %145, %146 : tensor<64x1xi32> loc(#loc33)
      %148 = arith.extsi %123 : i32 to i64 loc(#loc34)
      %149 = arith.extsi %arg7 : i32 to i64 loc(#loc34)
      %150 = arith.muli %148, %149 : i64 loc(#loc34)
      %c2147483647_i64_56 = arith.constant 2147483647 : i64 loc(#loc34)
      %c-2147483648_i64_57 = arith.constant -2147483648 : i64 loc(#loc34)
      %151 = arith.cmpi sle, %150, %c2147483647_i64_56 : i64 loc(#loc34)
      %152 = arith.cmpi sge, %150, %c-2147483648_i64_57 : i64 loc(#loc34)
      %153 = arith.andi %151, %152 : i1 loc(#loc34)
      %154 = arith.muli %123, %arg7 : i32 loc(#loc34)
      %155 = tt.splat %154 : i32 -> tensor<64x64xi32> loc(#loc35)
      %156 = tt.addptr %78, %155 : tensor<64x64x!tt.ptr<f32>>, tensor<64x64xi32> loc(#loc35)
      %cst_58 = arith.constant 0.000000e+00 : f32 loc(#loc36)
      %157 = tt.broadcast %147 : tensor<64x1xi1> -> tensor<64x64xi1> loc(#loc36)
      %cst_59 = arith.constant dense<0.000000e+00> : tensor<64x64xf32> loc(#loc36)
      %158 = tt.load %156, %157, %cst_59 : tensor<64x64x!tt.ptr<f32>> loc(#loc36)
      %cst_60 = arith.constant 0.000000e+00 : f32 loc(#loc37)
      %159 = tt.dot %144, %158, %arg10, inputPrecision = tf32 : tensor<128x64xf32> * tensor<64x64xf32> -> tensor<128x64xf32> loc(#loc37)
      scf.yield %159 : tensor<128x64xf32> loc(#loc38)
    } loc(#loc24)
    %86 = tt.expand_dims %17 {axis = 1 : i32} : tensor<128xi32> -> tensor<128x1xi32> loc(#loc39)
    %87 = tt.splat %arg8 : i32 -> tensor<128x1xi32> loc(#loc40)
    %88 = arith.extsi %86 : tensor<128x1xi32> to tensor<128x1xi64> loc(#loc40)
    %89 = arith.extsi %87 : tensor<128x1xi32> to tensor<128x1xi64> loc(#loc40)
    %90 = arith.muli %88, %89 : tensor<128x1xi64> loc(#loc40)
    %c2147483647_i64_33 = arith.constant 2147483647 : i64 loc(#loc40)
    %c-2147483648_i64_34 = arith.constant -2147483648 : i64 loc(#loc40)
    %cst_35 = arith.constant dense<2147483647> : tensor<128x1xi64> loc(#loc40)
    %91 = arith.cmpi sle, %90, %cst_35 : tensor<128x1xi64> loc(#loc40)
    %cst_36 = arith.constant dense<-2147483648> : tensor<128x1xi64> loc(#loc40)
    %92 = arith.cmpi sge, %90, %cst_36 : tensor<128x1xi64> loc(#loc40)
    %93 = arith.andi %91, %92 : tensor<128x1xi1> loc(#loc40)
    %94 = arith.muli %86, %87 : tensor<128x1xi32> loc(#loc40)
    %95 = tt.splat %arg2 : !tt.ptr<f32> -> tensor<128x1x!tt.ptr<f32>> loc(#loc41)
    %96 = tt.addptr %95, %94 : tensor<128x1x!tt.ptr<f32>>, tensor<128x1xi32> loc(#loc41)
    %97 = tt.expand_dims %33 {axis = 0 : i32} : tensor<64xi32> -> tensor<1x64xi32> loc(#loc42)
    %c1_i32_37 = arith.constant 1 : i32 loc(#loc43)
    %c1_i32_38 = arith.constant 1 : i32 loc(#loc43)
    %cst_39 = arith.constant dense<1> : tensor<1x64xi32> loc(#loc43)
    %98 = arith.extsi %97 : tensor<1x64xi32> to tensor<1x64xi64> loc(#loc43)
    %99 = arith.extsi %cst_39 : tensor<1x64xi32> to tensor<1x64xi64> loc(#loc43)
    %100 = arith.muli %98, %99 : tensor<1x64xi64> loc(#loc43)
    %c2147483647_i64_40 = arith.constant 2147483647 : i64 loc(#loc43)
    %c-2147483648_i64_41 = arith.constant -2147483648 : i64 loc(#loc43)
    %cst_42 = arith.constant dense<2147483647> : tensor<1x64xi64> loc(#loc43)
    %101 = arith.cmpi sle, %100, %cst_42 : tensor<1x64xi64> loc(#loc43)
    %cst_43 = arith.constant dense<-2147483648> : tensor<1x64xi64> loc(#loc43)
    %102 = arith.cmpi sge, %100, %cst_43 : tensor<1x64xi64> loc(#loc43)
    %103 = arith.andi %101, %102 : tensor<1x64xi1> loc(#loc43)
    %104 = arith.muli %97, %cst_39 : tensor<1x64xi32> loc(#loc43)
    %105 = tt.broadcast %96 : tensor<128x1x!tt.ptr<f32>> -> tensor<128x64x!tt.ptr<f32>> loc(#loc44)
    %106 = tt.broadcast %104 : tensor<1x64xi32> -> tensor<128x64xi32> loc(#loc44)
    %107 = tt.addptr %105, %106 : tensor<128x64x!tt.ptr<f32>>, tensor<128x64xi32> loc(#loc44)
    %108 = tt.expand_dims %17 {axis = 1 : i32} : tensor<128xi32> -> tensor<128x1xi32> loc(#loc45)
    %109 = tt.splat %arg3 : i32 -> tensor<128x1xi32> loc(#loc46)
    %110 = arith.cmpi slt, %108, %109 : tensor<128x1xi32> loc(#loc46)
    %111 = tt.expand_dims %33 {axis = 0 : i32} : tensor<64xi32> -> tensor<1x64xi32> loc(#loc47)
    %112 = tt.splat %arg5 : i32 -> tensor<1x64xi32> loc(#loc48)
    %113 = arith.cmpi slt, %111, %112 : tensor<1x64xi32> loc(#loc48)
    %114 = tt.broadcast %110 : tensor<128x1xi1> -> tensor<128x64xi1> loc(#loc49)
    %115 = tt.broadcast %113 : tensor<1x64xi1> -> tensor<128x64xi1> loc(#loc49)
    %116 = arith.andi %114, %115 : tensor<128x64xi1> loc(#loc49)
    tt.store %107, %85, %116 : tensor<128x64x!tt.ptr<f32>> loc(#loc50)
    tt.return loc(#loc51)
  } loc(#loc)
  tt.func private @"triton.language.standard.zeros____(0, 0)cconstexpr_128__(0, 1)cconstexpr_64__(1,)cconstexpr_fp32_"() -> tensor<128x64xf32> attributes {noinline = false} {
    ...
    %cst_0 = arith.constant dense<0.000000e+00> : tensor<128x64xf32> loc(#loc53)
    tt.return %cst_0 : tensor<128x64xf32> loc(#loc54)
  ^bb1:  // no predecessors
    %0 = ub.poison : tensor<128x64xf32> loc(#loc55)
    tt.return %0 : tensor<128x64xf32> loc(#loc55)
  } loc(#loc52)
  tt.func private @"triton.language.standard.cdiv__i32__(1,)cconstexpr_64_"(%arg0: i32 loc("/home/ubuntu/triton/python/triton/language/standard.py":31:0)) -> i32 attributes {noinline = false} {
    ...
    %c64_i32_0 = arith.constant 64 : i32 loc(#loc57)
    %0 = arith.extsi %arg0 : i32 to i64 loc(#loc57)
    %1 = arith.extsi %c64_i32_0 : i32 to i64 loc(#loc57)
    %2 = arith.addi %0, %1 : i64 loc(#loc57)
    %c2147483647_i64 = arith.constant 2147483647 : i64 loc(#loc57)
    %c-2147483648_i64 = arith.constant -2147483648 : i64 loc(#loc57)
    %3 = arith.cmpi sle, %2, %c2147483647_i64 : i64 loc(#loc57)
    %4 = arith.cmpi sge, %2, %c-2147483648_i64 : i64 loc(#loc57)
    %5 = arith.andi %3, %4 : i1 loc(#loc57)
    %6 = arith.addi %arg0, %c64_i32_0 : i32 loc(#loc57)
    %c1_i32 = arith.constant 1 : i32 loc(#loc58)
    %c1_i32_1 = arith.constant 1 : i32 loc(#loc58)
    %7 = arith.extsi %6 : i32 to i64 loc(#loc58)
    %8 = arith.extsi %c1_i32_1 : i32 to i64 loc(#loc58)
    %9 = arith.subi %7, %8 : i64 loc(#loc58)
    %c2147483647_i64_2 = arith.constant 2147483647 : i64 loc(#loc58)
    %c-2147483648_i64_3 = arith.constant -2147483648 : i64 loc(#loc58)
    %10 = arith.cmpi sle, %9, %c2147483647_i64_2 : i64 loc(#loc58)
    %11 = arith.cmpi sge, %9, %c-2147483648_i64_3 : i64 loc(#loc58)
    %12 = arith.andi %10, %11 : i1 loc(#loc58)
    %13 = arith.subi %6, %c1_i32_1 : i32 loc(#loc58)
    %c64_i32_4 = arith.constant 64 : i32 loc(#loc59)
    %c64_i32_5 = arith.constant 64 : i32 loc(#loc59)
    %14 = arith.divsi %13, %c64_i32_5 : i32 loc(#loc59)
    tt.return %14 : i32 loc(#loc60)
  ^bb1:  // no predecessors
    %15 = ub.poison : i32 loc(#loc61)
    tt.return %15 : i32 loc(#loc61)
  } loc(#loc56)
} loc(#loc)
...
#loc29 = loc("/home/ubuntu/triton/matmul.py":36:40)
#loc30 = loc("/home/ubuntu/triton/matmul.py":36:29)
#loc31 = loc("/home/ubuntu/triton/matmul.py":36:20)
#loc32 = loc("/home/ubuntu/triton/matmul.py":37:63)
#loc33 = loc("/home/ubuntu/triton/matmul.py":37:74)
#loc34 = loc("/home/ubuntu/triton/matmul.py":37:40)
#loc35 = loc("/home/ubuntu/triton/matmul.py":37:29)
#loc36 = loc("/home/ubuntu/triton/matmul.py":37:20)
#loc37 = loc("/home/ubuntu/triton/matmul.py":39:32)
#loc38 = loc("/home/ubuntu/triton/matmul.py":39:8)
#loc39 = loc("/home/ubuntu/triton/matmul.py":42:28)
#loc40 = loc("/home/ubuntu/triton/matmul.py":42:39)
#loc41 = loc("/home/ubuntu/triton/matmul.py":42:21)
#loc42 = loc("/home/ubuntu/triton/matmul.py":42:58)
#loc43 = loc("/home/ubuntu/triton/matmul.py":42:69)
...
#loc53 = loc("/home/ubuntu/triton/python/triton/language/standard.py":126:31)
#loc54 = loc("/home/ubuntu/triton/python/triton/language/standard.py":126:11)
#loc55 = loc("/home/ubuntu/triton/python/triton/language/standard.py":126:4)
#loc57 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:16)
#loc58 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:22)
#loc59 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:28)
#loc60 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:11)
#loc61 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:4)
